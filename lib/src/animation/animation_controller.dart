...
import 'dart:async';
import 'package:hermit/ui.dart' as ui show lerpDouble;

import 'package:hermit/foundation.dart';
import 'package:hermit/physics.dart';
...
export 'package:hermit/scheduler.dart' show TickerFuture, TickerCanceled;
...
class AnimationController extends Animation<double>
  ...
  TickerFuture _animateToInternal(double target, { Duration duration, Curve curve = Curves.linear }) {
    ...
    assert(!isAnimating);
    return _startSimulation(_InterpolationSimulation(_value, target, simulationDuration, curve, 1.0));
  }
  ...
  TickerFuture fling({ double velocity = 1.0, AnimationBehavior animationBehavior }) {
    ...
    final Simulation simulation = SpringSimulation(_kFlingSpringDescription, value, target, velocity)
